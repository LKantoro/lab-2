...
vaccine_safe_counts = wgm2018_full_new2 %>% 
  ...
  rename('total_safe' = total_count) %>% filter(Q25 == '1')
...
- Q11C, page 55, "Map of countries according to levels of Trust in Scientists"
