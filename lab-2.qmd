...
- There are three variables in this visualization. One is the percent of people in each country who trust vaccines. The other two are country, and global region. 
...
- The aesthetics used include x, y, color, and facet? .
...
- The graph is telling us how trust in scientists varies throughout the world.



8. List the variables that appear to be displayed in this visualization.

- The variables used are country, and the mean? of each response, on a scale of 1-4.
...
- Colors by another would provide additional information, such as (population or region)
